...
We adopt a linear friction model as described in Section \ref{sec:motor_friction_models}, incorporating both viscous and Coulomb friction, to accurately fit the observed data.
